...
//    public static final int TYPE_UCC = 6;
//
//    public static final int CVBS_PELCO_C = 0;
//    public static final int CVBS_A1_CCVC = 1;

    static final int TVI_HIK_VISION0 = 0;
    static final int TVI_HIK_VISION1 = 1;
    static final int TVI_PELCO_C = 2;

    static final int AHD_A_CP = 10;
//    public static final int AHD_A_CP_720P = 11;
    static final int AHD_A_CP_CVBS = 12;

    static final int CVI_DAHUA0 = 20;
    static final int CVI_DAHUA1 = 21;
    static final int CVI_DAHUA2 = 22;
}
